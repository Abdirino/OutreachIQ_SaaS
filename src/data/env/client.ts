...
export const env = createEnv({
    ...
    client: {
        ...
        NEXT_PUBLIC_CLERK_SIGN_IN_FORCE_REDIRECT_UR: z.string(),
    ...
    experimental__runtimeEnv: {
        ...
        NEXT_PUBLIC_CLERK_SIGN_IN_FORCE_REDIRECT_UR: process.env.NEXT_PUBLIC_CLERK_SIGN_IN_FORCE_REDIRECT_UR,
